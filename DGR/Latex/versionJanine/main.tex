...
\subsection{Trabajador}
    \text{(Clase abstracta)} \textbf{Descripción:}  Clase base para los diferentes tipos de trabajadores, como Owner o Usuario. Su propósito es centralizar los atributos comunes a todos los trabajadores y poder modelar la posibilidad de que tanto owners como users manejen productos.
...
\subsection{Owner}
    \text{(Subclase de Trabajador)} \textbf{Descripción:} Representa la cuenta asociada a la tienda y tiene la capacidad de crear cuentas de la clase Usuario.
    \begin{itemize}
        \item {\textbf{Atributos:}} Hereda los atributos de la clase abstracta Trabajador.
        \begin{itemize}
