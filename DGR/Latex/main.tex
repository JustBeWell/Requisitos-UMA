...
\begin{itemize}
    ...
    El usuario debe poder modificar los datos de la cuenta.
...
\begin{itemize}
    ...
    Todos los usuarios pueden definir etiquetas para categorizar assets y productos.

    \item \textbf{RF4.2 Visualizar etiquetas} \\
    Las etiquetas creadas deben poder ser visualizadas junto a sus datos: nombre, número de assets y número de productos asociados.
...
\begin{itemize}
    ...
    Todos los usuarios pueden definir atributos personalizados para los productos, tanto los del sistema como los atributos de usuario.
