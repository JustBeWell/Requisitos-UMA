...
\textbf{Dado} que el usuario ha iniciado sesión con su cuenta Owner,\par
\textbf{Y} se encuentra en la sección \enquote{Cuenta},\par
\textbf{Cuando} el usuario accede al apartado de informe de cuentas y ocurre un error interno del sistema mientras se genera el informe,\par
...
\begin{figure}[H]
    \includegraphics[width=1\linewidth]{assets/sequence/RF1.9_CrearInformeCuenta_v3.png}
