...
\addto\captionsspanish{%
  \renewcommand{\abstractname}{Recomendaciones}
}
...
\begin{abstract}
  ...
  También consultar \emph{1.3 Definiciones, acrónimos y abreviaturas} en caso de no entender alguna palabra técnica usada en esta memoria. De la misma manera, todos los Requisitos Funcionales y No Funcionales se detallan a fondo en el mismo documento.
\end{abstract}
