...
\include{body/RF4_GestionDeCategorias/page}
\include{body/RF6.1_CrearAtributo/page}
\include{body/RF6.2_LeerAtributo/page}
\include{body/RF6.3_ModificarAtributo/page}
\include{body/RF6.4_BorrarAtributo/page}
