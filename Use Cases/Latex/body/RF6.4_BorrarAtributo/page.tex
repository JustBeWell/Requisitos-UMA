...
\begin{enumerate}
    ...
    \item El usuario pulsa el boton de borrar.
...
\textbf{Cuando} pulsa el boton de borrar,\par
\textbf{Entonces} el sistema borra el atributo de la base de datos y vuelve a mostrar la lista de atributos.\par
\vspace{0.20cm}

\numberedsubsection{Bocetos}
\begin{figure}[H]
    \includegraphics[width=1\linewidth]{mockups/RF6 Modificar Atributos.png.png}
