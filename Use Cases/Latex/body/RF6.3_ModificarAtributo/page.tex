...
\begin{enumerate}
    \item El usuario selecciona el atributo que quiere modificar haciendo doble click en el \textit{GridAtributos}.
    \item El usuario hace doble click en el \textit{GridAtributos}.
...
\textbf{Cuando} hace doble click en el atributo,\par
